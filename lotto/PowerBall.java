...
public final class PowerBall extends AbstractBonusBall implements Lottery {
	 ...
	 */
	public static final String UPDATE_URL = "http://www.walottery.com/WinningNumbers/Search.aspx?game=44&year=";

	/**
	 * Creates a new instance of this.
	 */
	public PowerBall() {
		super(RANGE, NUMBER_OF_BALLS, BONUS_BALL_RANGE, NUMBER_OF_BONUS_BALLS,
				DATA_FILE);
	}
