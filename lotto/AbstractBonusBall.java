 ...
 * @author Robert
 */
public abstract class AbstractBonusBall extends AbstractLottery implements
		Lottery {
	/**
	...
	/**
	 * A protected constructor that sets the fields according to the passed
	 * values from the child class.
	 * 
	 * @param theRange
	 *            the ball number range
	 * @param theNumberOfBalls
	 *            the number of number balls
	 * @param theBonusBallRange
	 *            the bonus ball range
	 * @param theNumberOfBonusBalls
	 *            the number of bonus balls
	 * @param theFile
