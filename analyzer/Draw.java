...
public final class Draw {
    /** The space character used in the toString(). */
    private static final char SPACE = ' ';
    /** The tab character used in the toString(). */
     ...
     * 
     * @param theDate draw date
     * @param theNumbers numbers drawn
     * @param theBonusBall the bonus ball drawn
     * @param theJackpotStatus if this draw was a jackpot winner
     * @param thePayout the payout
     * @param theNumberRange the number range applicable on this draw
     * @param theBonusBallRange the bonus ball range applicable on this draw
     */
    public Draw(final String theDate, final int[] theNumbers, final int theBonusBall,
                final boolean theJackpotStatus, final long thePayout,
                final int theNumberRange, final int theBonusBallRange) {
        myDate = theDate;
     ...
     * 
     * @param theDate the draw date
     * @param theNumbers the numbers drawn
     * @param theJackpotStatus if this draw was a jackpot winner
     * @param thePayout the total payout from this drawing
     * @param theNumberRange the range of applicable numbers
     */
    public Draw(final String theDate, final int[] theNumbers, final boolean theJackpotStatus,
     ...
     * 
     * @param theOther the Draw object to copy
     */
